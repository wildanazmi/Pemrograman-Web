$(document).ready(function() {
    ...
    $("#form-komentar").submit(function(e) {
        ...
        if (passed === true && name.length < 5) passed = 'Masukkan nama minimal 5 karakter!';
        if (passed === true && komentar.length < 20) passed = 'Masukkan minimal 20 karakter untuk komentar!';
        if (passed === true && /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(email) == false) passed = 'Masukkan email yang valid!';
